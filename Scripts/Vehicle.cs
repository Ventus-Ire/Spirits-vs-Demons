...
public abstract class Vehicle : MonoBehaviour 
{
    ...
    //Avoids obstacles depending on the size of the box collider
    //The box collider just aids with seperation, the method actually makes the objects avoid the collider
    ...
    //Another attempt at calculating the wander method
    //The method forces a character to a specific point in the map and then randomly wanders the map
	/*
	...
	*/
    //Another attempt at calculating the wander method
    //Does provide better results but still attempts to go to the center
    ...
    //Returns a random vector from a point inside a projected circle
    //Passes in a displaced vector and the amount of displacement via "number"
    ...
    //Attempt at separation within the game
    //This adds up all of the distances between the surrounding objects of the same type and then shoves
    //All of them to different locations in the map except for the first one in the array
